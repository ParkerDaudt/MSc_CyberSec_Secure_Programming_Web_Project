   ...
   <body>
	<center>
      ...
      <div id="signup">   
		 ...
		 <form action="register.php" method="post" autocomplete="off" style="background-color: white; border-style: solid; border-color: #52bad5; border-width: 10px; max-width: 310px; max-height: inherit; border-radius: 25px">
          <center>
          <div class="top-row">
